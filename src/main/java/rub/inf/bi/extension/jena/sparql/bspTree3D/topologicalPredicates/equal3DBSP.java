...
public class equal3DBSP extends FunctionBase2 {
    ...
    public NodeValue exec(NodeValue v1, NodeValue v2) {
        ...
        //* Case 1: (MULTI)POLYGON <--> (MULTI)POLYGON
        if ( (geom1 instanceof MultiPolygon && geom2 instanceof MultiPolygon) 
        || (geom1 instanceof Polygon && geom2 instanceof Polygon) ) {
            ...
            for (Polygon p2: polygonsLst2){
                if (t1.traverseEQUAL(t1, p2) == false){
